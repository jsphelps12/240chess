...
//        ws.send("PlaceHolder");
    ...
    public void highlightMoves(Position startPos){
        Game game = new Game(latestGame);
        Collection<ChessMove> validMoves= game.validMoves(startPos);
        if(userColor.equals("BLACK")){
            drawBlackHighlight(latestGame,validMoves,startPos);
        }
        else{
            drawWhiteHighlight(latestGame,validMoves,startPos);
        }
...
//        out.print(ERASE_SCREEN);
    ...
    public void drawBlackHighlight(String game, Collection<ChessMove> validMoves, Position startPos){
        Game tempGame = new Game(game);
        var out = new PrintStream(System.out, true, StandardCharsets.UTF_8);
//        out.print(ERASE_SCREEN);
        out.print(SET_TEXT_COLOR_BLACK);
        ...
        for(int i = 1; i < 9; i++){
            ...
            for(int j = 8; j > 0; j--){
                ...
                if(startPos.getRow() == i && startPos.getColumn() == j){
...
//        out.print(ERASE_SCREEN);
    ...
    public void drawWhiteHighlight(String game, Collection<ChessMove> validMoves, Position startPos){
        Game tempGame = new Game(game);
        var out = new PrintStream(System.out, true, StandardCharsets.UTF_8);
//        out.print(ERASE_SCREEN);
        out.print(SET_TEXT_COLOR_BLACK);
